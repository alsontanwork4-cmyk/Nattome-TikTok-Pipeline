...
| Automatic refresh remains part of dashboard read paths | Covered by `test_dashboard_read_paths_keep_automatic_refresh_contract`, plus behavior tests around Overview, Search, Run History, Recommendations, Pattern Library, and architecture browsing. |
