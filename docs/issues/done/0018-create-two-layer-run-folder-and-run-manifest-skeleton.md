...
Create the new Run Folder skeleton for Batch Analysis Runs using only two folder layers. New runs should create direct child folders for reports, data, evidence, and logs, and write an incremental `run_manifest.json`.
...
- [ ] `run_manifest.json` records the generated run folders and active outputs.
